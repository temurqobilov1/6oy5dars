...
function Login() {
  return (
      <form action="" className="w-[460px]  mt-20 mx-auto bg-[#f2f4f7]  flex flex-col gap-4 py-6  rounded-xl shadow-2xl">
        <div className="mx-auto mb-4" >
          <h1 className="text-5xl font-bold text-[#166fe5]">Login</h1>
        </div>
        <div className="mx-auto mb-3">
        <input className="border text-black px-3 rounded text-xl w-[360px] h-13" type="email" placeholder="Email address or phone number"/>
      </div>
        <div className="mx-auto mb-3">
